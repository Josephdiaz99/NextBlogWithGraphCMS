...
const CommentsForm = ({slug }) => {
  ...
  useEffect(() => {
    ...
    nameEl.current.value=w.localStorage.getItem('name')
    emailEl.current.value=w.localStorage.getItem('email')
      ...
      if(storeData){
        ...
        w.localStorage.setItem('email',email)
      }else{
        w.localStorage.removeItem('name',name)
        w.localStorage.removeItem('email',email)
      }
